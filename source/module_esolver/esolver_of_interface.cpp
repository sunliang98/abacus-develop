 ...
 * @param inp
 */
void ESolver_OF::init_kedf(Input& inp, UnitCell& ucell)
{
    ...
    if (this->of_kinetic_ == "ml" || this->of_kinetic_ == "mpn")
    {
        ...
        this->ml_->set_para(this->pw_rho->nrxx, this->dV_, this->nelec_[0], inp.of_tf_weight, inp.of_vw_weight, 
                        ...
                        inp.of_ml_tanhxi_nl, inp.of_ml_tanh_pnl, inp.of_ml_tanh_qnl, inp.of_ml_tanhp_nl, inp.of_ml_tanhq_nl, inp.of_ml_device,
                        inp.of_ml_mu, inp.of_ml_n_max, this->pw_rho, ucell);
    }
}
