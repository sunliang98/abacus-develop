...
torch::Tensor Train::potTanhxiTerm1(
    const torch::Tensor &xi,
    const torch::Tensor &tanhxi,
    const torch::Tensor &gradient
)
...
torch::Tensor Train::potTanhpTerm1(
    const torch::Tensor &p,
    const torch::Tensor &tanhp,
    const torch::Tensor &gradient
)
...
torch::Tensor Train::potTanhqTerm1(
    const torch::Tensor &q,
    const torch::Tensor &tanhq,
    const torch::Tensor &gradient
)
...
torch::Tensor Train::potXinlTerm(
    const torch::Tensor &rho,
    const torch::Tensor &kernel,
    const torch::Tensor &tauTF,
    const torch::Tensor &gradient
...
torch::Tensor Train::potTanhxinlTerm(
    const torch::Tensor &rho,
    const torch::Tensor &tanhxi,
    const torch::Tensor &kernel,
    const torch::Tensor &tauTF,
...
torch::Tensor Train::potTanhqTanh_qnlTerm(
    const torch::Tensor &rho,
    const torch::Tensor &q,
    const torch::Tensor &tanhq,
    const torch::Tensor &tanh_qnl,
...
torch::Tensor Train::potTanhpTanhp_nlTerm(
    const torch::Tensor &rho,
    const torch::Tensor &nablaRho,
    const torch::Tensor &p,
    const torch::Tensor &tanhp,
...
torch::Tensor Train::potTanhqTanhq_nlTerm(
    const torch::Tensor &rho,
    const torch::Tensor &q,
    const torch::Tensor &tanhq,
    const torch::Tensor &kernel,
