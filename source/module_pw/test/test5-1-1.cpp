...
TEST_F(PWTEST,test5_1_1)
{
    cout<<"dividemthd 1, gamma_only: off, full_pw: true, full_pw_dim: 1, check gcar,gdirect,gg,istot2ixy,ig2isz"<<endl;
    //--------------------------------------------------
    ...
    //ref
    const int totnpw_ref = 3375;
    const int totnst_ref = 225;
    const int nx_ref = 75;
    const int ny_ref = 3;
    const int nz_ref = 15;
    ...
    int npw_per_ref[12][12]={
        ...
        {840,840,855,840},
        {675,675,675,675,675},
        {570,570,555,555,555,570},
        {480,480,480,480,480,495,480},
        {420,420,420,420,420,420,435,420},
        {375,375,375,375,375,375,375,375,375},
        {345,345,345,345,330,330,330,330,345,330},
        {315,315,315,315,300,300,300,300,300,315,300},
        {285,285,285,285,285,285,285,285,270,270,285,270}
    };
    int nst_per_ref[12][12]={
        ...
        {45,45,45,45,45},
        {38,38,37,37,37,38},
        {32,32,32,32,32,33,32},
        {28,28,28,28,28,28,29,28},
        {25,25,25,25,25,25,25,25,25},
        {23,23,23,23,22,22,22,22,23,22},
        {21,21,21,21,20,20,20,20,20,21,20},
        {19,19,19,19,19,19,19,19,18,18,19,18}
    };
    int *npw_per = nullptr;
    if(rank_in_pool == 0)
    {
