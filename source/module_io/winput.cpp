...
void winput::Read(const std::string& fn)
{
    ...
    while (ifs.good())
    {
        ...
        if (std::strcmp(word, "WANNIER_PARAMETERS") == 0)
        {
            ierr = 1;
            break;
        }
    ...
    while (ifs.good())
    {
        ...
        {
            read_value(ifs, target);
        }
        else if (strcmp("trial", word) == 0)
        {
            read_value(ifs, trial);
        }

        else if (strcmp("near_atom", word) == 0)
        {
            read_value(ifs, b_near_atom);
        }
        else if (strcmp("range0", word) == 0)
        {
            read_value(ifs, range0);
        }
        else if (strcmp("range1", word) == 0)
        {
            read_value(ifs, range1);
        }

        else if (strcmp("wlmr_dir", word) == 0)
        {
            read_value(ifs, wlmr_dir);
        }
        else if (strcmp("no_center", word) == 0)
        {
            read_value(ifs, no_center);
        }
        else if (strcmp("sph_proj", word) == 0)
        {
            read_value(ifs, sph_proj);
        }
        else if (strcmp("sph_type", word) == 0)
        {
            read_value(ifs, sph_type);
        }
        else if (strcmp("b_recon", word) == 0)
        {
            read_value(ifs, b_recon);
        }
        else if (strcmp("speed_mode", word) == 0)
        {
            read_value(ifs, speed_mode);
        }
        else if (strcmp("recon_wanq", word) == 0)
        {
            read_value(ifs, recon_wanq);
        }
        else if (strcmp("b_mix_wf", word) == 0)
        {
            read_value(ifs, b_mix_wf);
        }
        else if (strcmp("b_near_atom", word) == 0)
        {
            read_value(ifs, b_near_atom);
        }
        else if (strcmp("mix_wf", word) == 0)
        {
            read_value(ifs, mix_wf);
        }

        else if (strcmp("wf_type", word) == 0)
        {
            read_value(ifs, wf_type);
        }
        else if (strcmp("build_wf", word) == 0)
        {
            read_value(ifs, build_wf);
        }
        else if (strcmp("imp_pao", word) == 0)
        {
            read_value(ifs, imp_pao);
        }
        else if (strcmp("b_out_wf", word) == 0)
        {
            read_value(ifs, b_out_wf);
        }
        else if (strcmp("b_plot_build", word) == 0)
        {
            read_value(ifs, b_plot_build);
        }
        else if (strcmp("b_plot_atomic", word) == 0)
        {
            read_value(ifs, b_plot_atomic);
        }
        else if (strcmp("plot_option", word) == 0)
        {
            read_value(ifs, plot_option);
        }
        else if (strcmp("n_unitcell", word) == 0)
        {
            read_value(ifs, n_unitcell);
        }

        else if (strcmp("l_start", word) == 0)
        {
            read_value(ifs, L_start);
        }
        else if (strcmp("l_end", word) == 0)
        {
            read_value(ifs, L_end);
        }
        else if (strcmp("atom_start", word) == 0)
        {
            read_value(ifs, atom_start);
        }
        else if (strcmp("atom_end", word) == 0)
        {
            read_value(ifs, atom_end);
        }

        else if (strcmp("trunc_ao", word) == 0)
        {
            read_value(ifs, trunc_ao);
        }
        else if (strcmp("trunc_wlmr", word) == 0)
        {
            read_value(ifs, trunc_wlmr);
        }
        else if (strcmp("trunc_wan", word) == 0)
        {
            read_value(ifs, trunc_wan);
        }
        else if (strcmp("fermi_t", word) == 0)
        {
            read_value(ifs, fermi_t);
        }
        else if (strcmp("clm2_lowest", word) == 0)
        {
            read_value(ifs, clm2_lowest);
        }
        else if (strcmp("rcut", word) == 0)
        {
            read_value(ifs, rcut);
        }

        else if (strcmp("plotflag", word) == 0)
        {
            read_value(ifs, plot_option);
        }
        else if (strcmp("unit", word) == 0)
        {
            read_value(ifs, n_unitcell);
        }

        else if (strcmp("bs", word) == 0)
        {
            read_value(ifs, bs);
        }
        else if (strcmp("bp", word) == 0)
        {
            read_value(ifs, bp);
        }
        else if (strcmp("px", word) == 0)
        {
            read_value(ifs, px);
        }
        else if (strcmp("g1", word) == 0)
        {
            read_value(ifs, g1);
        }
        else if (strcmp("g2", word) == 0)
        {
            read_value(ifs, g2);
        }

        else if (strcmp("before_iter", word) == 0)
        {
            read_value(ifs, before_iter);
        }
        else if (strcmp("after_iter", word) == 0)
        {
            read_value(ifs, after_iter);
        }

        else if (strcmp("begin_stop_flag", word) == 0)
        {
            read_value(ifs, begin_stop_flag);
        }
        else if (strcmp("end_flag", word) == 0)
        {
            read_value(ifs, end_flag);
        }

        else if (strcmp("out_all", word) == 0)
        {
            read_value(ifs, out_all);
        }
        else if (strcmp("out_chg", word) == 0)
        {
            read_value(ifs, out_chg);
        }
        else if (strcmp("charge_type", word) == 0)
        {
            read_value(ifs, charge_type);
        }
        else if (strcmp("compare_atomic", word) == 0)
        {
            read_value(ifs, compare_atomic);
        }
        // add 2008-1-26
        else if (strcmp("plot_wanq", word) == 0)
        {
            read_value(ifs, plot_wanq);
        }

        // add 2008-3-10
        else if (strcmp("cal_bands", word) == 0)
        {
            read_value(ifs, cal_bands);
        }
        else if (strcmp("cal_bands2", word) == 0)
        {
            read_value(ifs, cal_bands2);
        }
        else if (strcmp("chgtype", word) == 0)
        {
            read_value(ifs, charge_type);
        }
        else if (strcmp("cal_dos", word) == 0)
        {
            read_value(ifs, cal_dos);
        }
        else if (strcmp("sum_lm", word) == 0)
        {
            read_value(ifs, sum_lm);
        }

        // add 2008-3-17
        else if (strcmp("bloch_begin", word) == 0)
        {
            read_value(ifs, bloch_begin);
        }
        else if (strcmp("bloch_end", word) == 0)
        {
            read_value(ifs, bloch_end);
        }

        else if (strcmp("mesh", word) == 0)
        {
            read_value(ifs, mesh);
        }
        ...
        // add 2008-07-20
        else if (strcmp("b_fftwan", word) == 0)
        {
            read_value(ifs, b_fftwan);
        }
        // add 2009-04-19
        else if (strcmp("out_spillage", word) == 0)
        {
            read_value(ifs, out_spillage);
        }
        // add 2010-06-07
        else if (strcmp("spillage_outdir", word) == 0)
        {
            read_value(ifs, spillage_outdir);
        }
        else
        {
            if (word[0] != '#' && word[0] != '/')
