...
TEST_F(PWTEST,test6_1_1)
{
    cout<<"dividemthd 2, gamma_only: off, full_pw: true, full_pw_dim: 1, check gcar,gdirect,gg,istot2ixy,ig2isz"<<endl;
    //--------------------------------------------------
    ModuleBase::Matrix3 latvec(10,1,0,0,1,0,0,0,5);
    ...
    //ref
    const int totnpw_ref = 1215;
    const int totnst_ref = 81;
    const int nx_ref = 27;
    const int ny_ref = 3;
    const int nz_ref = 15;
    ...
    int npw_per_ref[12][12]={
        ...
        {315,300,300,300},
        {255,240,240,240,240},
        {210,210,210,195,195,195},
        {180,180,180,180,165,165,165},
        {165,150,150,150,150,150,150,150},
        {135,135,135,135,135,135,135,135,135},
        {135,120,120,120,120,120,120,120,120,120},
        {120,120,120,120,105,105,105,105,105,105,105},
        {105,105,105,105,105,105,105,105,105,90,90,90}
    };
