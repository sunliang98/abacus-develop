...
TEST_F(PWTEST,test6_2_2)
{
    cout<<"dividemthd 2, gamma_only: on, full_pw: true, full_pw_dim: 2, check gcar,gdirect,gg,istot2ixy,ig2isz"<<endl;
    //--------------------------------------------------
    ...
    const int totnst_ref = 108;
    const int fftnx_ref = 12;
    const int ny_ref = 16;
    const int fftny_ref = 9;
    const int fftnz_ref = 30;
    ...
    int npw_per_ref[12][12]={
        ...
        {480,480,480,450,450,450,450},
        {420,420,420,420,390,390,390,390},
        {360,360,360,360,360,360,360,360,360},
        {330,330,330,330,330,330,330,330,300,300},
        {300,300,300,300,300,300,300,300,300,270,270},
