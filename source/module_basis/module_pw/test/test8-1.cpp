...
TEST_F(PWTEST,test8_1)
{
    cout<<"dividemthd 2, gamma_only: on, xprime: true, full_pw: true, full_pw_dim: 0, check gcar,gdirect,gg,istot2ixy,ig2isz"<<endl;
    //--------------------------------------------------
    ...
    int npw_per_ref[12][12]={
        ...
        {840,840,840,840},
        {672,672,672,672,672},
        {576,576,552,552,552,552},
        {480,480,480,480,480,480,480},
        {432,432,432,432,408,408,408,408},
        {384,384,384,384,384,360,360,360,360},
        {336,336,336,336,336,336,336,336,336,336},
        {312,312,312,312,312,312,312,312,288,288,288},
        {288,288,288,288,288,288,288,288,264,264,264,264}
    };
