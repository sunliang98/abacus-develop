...
{
    cout<<"dividemthd 2, gamma_only: off, full_pw: true, full_pw_dim: 2, check gcar,gdirect,gg,istot2ixy,ig2isz"<<endl;
    //--------------------------------------------------
    ...
    int npw_per_ref[12][12]={
        ...
        {288,272,272,272,272,272,272},
        {240,240,240,240,240,240,240,240},
        {224,224,224,208,208,208,208,208,208},
