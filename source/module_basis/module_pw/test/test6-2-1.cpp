...
TEST_F(PWTEST,test6_2_1)
{
    cout<<"dividemthd 2, gamma_only: on, full_pw: true, full_pw_dim: 1, check gcar,gdirect,gg,istot2ixy,ig2isz"<<endl;
    //--------------------------------------------------
    ...
    int npw_per_ref[12][12]={
        ...
        {486,459,459,459,459,459,459},
        {405,405,405,405,405,405,405,405},
        {378,378,378,351,351,351,351,351,351},
