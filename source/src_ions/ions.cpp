...
void Ions::opt_ions_pw(ModuleESolver::ESolver *p_esolver)
{
    ...
    //----------------------------------------------------------	
		...
		int eiter=0;		
        if (GlobalV::CALCULATION=="scf" || GlobalV::CALCULATION=="md" || GlobalV::CALCULATION=="relax" || GlobalV::CALCULATION=="cell-relax" || GlobalV::CALCULATION.substr(0,3)=="sto" || GlobalV::CALCULATION=="ofdft" )  // pengfei 2014-10-13
        {
#ifdef __LCAO
#ifdef __MPI
    ...
    if(GlobalV::CALCULATION=="scf" || GlobalV::CALCULATION=="relax" || GlobalV::CALCULATION=="cell-relax" || GlobalV::CALCULATION.substr(0,3)=="sto" || GlobalV::CALCULATION=="ofdft")
    {
        GlobalV::ofs_running << "\n\n --------------------------------------------" << std::endl;
