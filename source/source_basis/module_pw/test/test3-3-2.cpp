...
using namespace std;
TEST_F(PWTEST,test3_3_2)
{
    cout<<"dividemthd 1, gamma_only: off, xprime: true, check fft between r & c"<<endl;
    ...
    //--------------------------------------------------
    lat0 = 3;
    ModuleBase::Matrix3 la(1, 0, 0, 0, 1, 0, 0, 0, 0.2);
    latvec = la;
    wfcecut = 4;
    gamma_only = false;
...
#endif
    pwtest.initgrids(lat0,latvec, 10, 10, 2);
