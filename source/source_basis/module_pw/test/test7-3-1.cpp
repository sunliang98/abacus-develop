...
using namespace std;
TEST_F(PWTEST,test7_3_1)
{
    cout<<"dividemthd 1, gamma_only: off, xprime: true, full_pw: true, full_pw_dim: 1, check fft between complex and complex, reset ggecut to latecut"<<endl;
